...
public class Stuff extends JFrame implements ActionListener {
    ...
    @Override public void actionPerformed(ActionEvent e) {
        Metodos obj= new Metodos();                                //Instanciamos un objeto de lase Metodos()
       if(e.getSource()==calcular){                                //Por medio de los ActionListener recibimos datos tecleados por el usuario
